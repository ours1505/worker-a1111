...
RUN apk add --no-cache wget && \
    wget --content-disposition "https://civitai.com/api/download/models/174317?type=Model&format=SafeTensor&size=pruned&fp=fp16" --quiet
RUN wget --content-disposition "https://civitai.com/api/download/models/174317?type=VAE&format=SafeTensor" --quiet
